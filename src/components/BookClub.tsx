...
export function BookClub() {
    return (
        <section
            className="book-club px-[var(--space-2)] py-[var(--space-3)] flex flex-col lg:flex-row lg:items-center gap-8
         lg:gap-12 max-w-[74rem] mx-auto"
        >
            ...
            <div
                className="book-club-image flex-1 rounded-[var(--radius-12)] overflow-hidden
             ...
             before:h-[138px] md:before:bg-[url('/assets/images/logos-tech.svg')] before:bg-cover
                          before:bg-center before:z-[1]  lg:before:left-[2rem]"
            >
                <picture>
                    <source
